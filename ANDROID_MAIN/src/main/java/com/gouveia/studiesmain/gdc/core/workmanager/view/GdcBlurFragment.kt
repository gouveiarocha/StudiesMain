...
import com.gouveia.studiesmain.databinding.FragmentGdcBlurBinding
import com.gouveia.studiesmain.gdc.core.workmanager.utils.KEY_IMAGE_URI
import com.gouveia.studiesmain.gdc.core.workmanager.viewmodel.BlurViewModel

class GdcBlurFragment : Fragment(R.layout.fragment_gdc_blur) {

    private lateinit var viewModel: BlurViewModel
    private lateinit var binding: FragmentGdcBlurBinding

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentGdcBlurBinding.bind(view)
